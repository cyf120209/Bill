...
import com.example.aa.settlement.view.SettlementFragment;
import com.example.aa.user.view.ContainerFragment;
import com.example.aa.user.view.UserFragment;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_gallery:
                replaceFragment(new ContainerFragment(),false);
                break;
            case R.id.nav_settlement:
                replaceFragment(new SettlementFragment(),false);
                break;
        }
